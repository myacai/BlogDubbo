...
import com.cai.util.subStringUtil;
      ...
      while (fileNamesIter.hasNext()) {
        ...
        if (file != null) {
          ...
          if (myFileName.trim() != "") {
            ...
            String filePath = "C:\\Users\\Administrator\\Desktop\\码云SSM\\Art_Blog\\src\\main\\webapp\\images\\upload\\"
            ...
            System.out.println("uploadBg");
            System.out.println(fileNames);
            fileNames = "images/upload/" + newFileName + "/" + fileNames;
            System.out.println(fileNames);
