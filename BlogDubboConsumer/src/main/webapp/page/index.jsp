...
<meta name="keywords" content="个人博客,蔡雯彬个人博客,蔡雯彬" />
<meta name="description" content="蔡雯彬个人博客" />
...
<body
  style="background:url(${pageContext.request.contextPath}/images/bj.jpg); background-position: center center;
          background-repeat:no-repeat; background-attachment: fixed; background-size: cover;background-color: #CCCCCC;">
  <%@ include file="top.jsp"%>
  <article style="opacity:0">
    <!-- <div class="pics ">
			<ul> repeat top left scroll;z-index:-2
				<li></li>
				<li></li>
				<li></li>
			</ul>
      ...
      <div class="guanzhu gd whitebg animated fadeIn"
        ...
        <ul>
          <li class="qq"><a href="javascript:void(0)"
            target="_blank"><span>QQ号</span>1152641262</a></li>
          <li class="email"><a href="javascript:void(0)"
            target="_blank"><span>邮箱帐号</span>1152641262@qq.com</a></li>
          <li class="wxgzh"><a href="javascript:void(0)"
            target="_blank"><span>微信号</span>115264cai</a></li>
