            ...
            <c:when test="${status== '0' || status== '500'}">
              ...
              <h4 style="margin-top:55px;text-align:center;">
                <a
                  ...
                  href="${pageContext.request.contextPath}/index2.jsp">去首页</a>
              </h4>
            </c:when>
            <c:otherwise>
              ...
              <div class="news_author animated fadeIn">
                <span class="au01 ">蔡雯彬</span><span class="au02">
              ...
              <p
                ...
                <b>转载：</b>感谢您对蔡雯彬个人博客网站平台的认可，及对该作品以及文章的青睐，非常欢迎各位朋友分享到个人站长或者朋友圈，但转载请说明文章出处。本文章部分图片、文章来源于网络，版权归原作者所有，如有侵权，请与我联系删除。
              </p>
            </c:otherwise>
          </c:choose>
        </div>
